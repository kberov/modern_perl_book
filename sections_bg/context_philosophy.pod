...
Кръглите скоби на втория ред от предния пример групират две декларции (L<lexical_scope>)
...
Изпълнението на функция в списъчен контекст без видимо присвояване може да
...
Използвайте оператора C<scalar>, за да извикате функциаята в скаларен контекст.
...
данните, които съдържа една променлива или връща дадена функция, типовите контексти в Perl предоставят подсказки, които казват на компилатора как да третира данните.
