...
Когато променливите позволяват абстрактно манипулиране с данните, стойностите им
...
бързи, възможно най-компактни и ефективни) начини за представяне на данните.
