...
Идиомите в Perl не са точно свойства на езика или пък техники на дизайна. Те са по-скоро
маниерничене и трикове, които, взети заедно, придават на кода ви по-Perl вид. Използването им не е задължително,
но те са част от силата на Perl. 
...
Обектната система на Perl 5 (L<moose>) третира извикващия клас или
обект като обикновен параметър на метода. 
