...
I<Файловете> си осигуряват такъв лексикслен обхват, че декларирането на C<package>
...
Декларираните знаци за тип определят типа на променливата: скалар, масив или хеш.
