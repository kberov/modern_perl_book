...
X<нулев брой аргументи>
X<унарна>
X<бинарна>
X<тринарна>
X<списъчно>

Всеки оператор работи върху някакъв брой аргументи.  A I<nullary>
operator operates on zero operands. A I<unary> operator operates on
one operand. I<Бинарния> оператор работи върху два
аргумента. I<Тернарен> оператор работи върху три аргумента.
I<списъчен> оператор работи върху списък с аргументи. Документацията
за всеки оператор и дадените примери с него би трябвало да покажаш
ясно върху какъв брой аргументи работи.
