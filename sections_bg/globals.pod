...
Perl 5 има няколко I<супер глобални променливи> които са наистина глобални, не са само в областта на видимост на един пакет или файл.
За нещастие, тяхната глобална достъпност означава също че всякакви преки и непреки промени могат да се отразят на други 
части от програмата. Опитните програмисти на Perl 5 запомят някои от тези променливи. 
Малко хора запомят всички супер глобални променливи. В същност само малка част от тези променливи влиза в употреба.
C<perldoc perlvar> съдържа пълният списък с тези променливи.

=head2 Употреба на супер глобалните променливи
